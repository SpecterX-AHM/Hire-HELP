...
module.exports = {
	...
	async landingPage(req, res, next) {
		...
		res.render('index', { posts, mapBoxToken, recentPosts, title: 'Hire HELP - Home' });
	},
	// GET /stories
	async stories(req,res,next){
		res.render('stories', { title :'Hire HELP - Stories'});
	},
	...
	async postRegister(req, res, next) {
		try {
			...
			req.login(user, function(err) {
				...
				req.session.success = `Welcome to Hire HELP, ${user.username}!`;
				res.redirect('/');
			});
		} catch(err) {
...
async putForgotPw(req, res, next) {
  ...
  const msg = {
    to: user.email,
    from: 'Hire HELP Admin <khanhumayun95@gmail.com>',
    subject: 'Hire HELP - Forgot Password / Reset',
